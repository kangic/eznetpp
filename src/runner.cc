...
// not thread safe
void runner::add_to_running_list(if_server* server) {
...
// not thread safe
void runner::del_from_running_list(if_server* server) {
  std::vector<if_server*>::iterator iter;
...
// not thread safe
void runner::add_to_running_list(if_client* client) {
...
// not thread safe
void runner::del_from_running_list(if_client* client) {
  std::vector<if_client*>::iterator iter;
